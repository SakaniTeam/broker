  ...
  child: ListTile(
    onLongPress: () {
      AwesomeDialog(
        ...
        btnOkOnPress: () async {
          ...
          isResd
              ? deleteResidintial(
                  "${resdintial[index]['documentId']}", index)
              : deleteCommercial(
                  "${comerrical[index]['documentId']}", index);
          setState(() {});
    ...
    leading: Container(
      ...
      child: Image.network(
        ...
        fit: BoxFit.cover, // This ensures that the image covers the specified width and height
       height: 300,
        ),
    ),
    title: Text(
                    ...
                    child: Row(
                      ...
                      children: [
                        MaterialButton(
                          ...
                          child: const Text('Commercial ',style:TextStyle(color :Colors.white , fontWeight: FontWeight.bold ,fontSize: 18) ,),
                        ),
                        const SizedBox(
                          width: 20,
                        ),
